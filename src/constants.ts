...
export const DAILY_REWARDS_RATE = new anchor.BN(
  10000 * 10 ** DEFAULT_TOKEN_DECIMALS
);
...
export const FULL_SHARE = ANNUAL_REWARDS_RATE.mul(new anchor.BN(100)).div(
  new anchor.BN(100)
);

export const MONKEY_SPOOK_BOX_SHARE = ANNUAL_REWARDS_RATE.div(
  new anchor.BN(10)
);
...
export const NFT_UPDATE_AUTHORITY = new PublicKey(
  "DoNmbbtRBdnhCyQR5tLBJxpKhP9h5paKspC4XfJutBJD"
);
